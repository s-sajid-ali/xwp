 ...
 *                          double wavel, double z):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_20prop2d_cython_4_loop_1exact_prop_2D_cython, NULL, __pyx_n_s_prop2d_cython_4_loop); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
